...
Ela foi entregue ao Windows por OpenCore, mas não demonstrou ser suficiente
para iniciar o Hyper-V. Portanto é uma candidata de investigação, não uma BIOS
pronta para flash. O rebuild rejeitado permanece marcado em
`archive/experiments/rejected/`.

Imagens SPI integrais de recuperação não fazem parte deste repositório público.
