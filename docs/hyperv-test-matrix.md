...
O plano de captura com um segundo PC está em `docs/hyperv-debugging.md`. O Ethernet físico Realtek `10EC:8168` desta placa consta na lista oficial de NICs KDNET; a ferramenta ainda não está instalada e nenhuma configuração de depuração foi aplicada.
